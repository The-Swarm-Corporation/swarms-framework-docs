...
<ParamField path="heavy_swarm_use_grok_agents" type="bool" default="False">
  Run the four-agent Grok 4.20 Heavy roster (Captain Swarm + Harper, Benjamin, Lucas) instead of the default agents. See [Heavy Swarm](/architectures/heavy-swarm) for the full Grok modes.
</ParamField>
