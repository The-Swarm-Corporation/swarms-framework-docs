...
Run multiple tasks in parallel using threads — one conversation per task, executed simultaneously.
...
For dynamic behavior that follows @mentions, a custom function can return a list of agents:
