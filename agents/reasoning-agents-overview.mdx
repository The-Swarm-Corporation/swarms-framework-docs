...
description: Sophisticated agents that employ advanced cognitive strategies to improve problem-solving beyond standard language model capabilities
icon: "brain"
---
...
|------------|------|----------------|---------------|----------------|----------------|---------------|
| **Self-Consistency Agent** | Consensus-based | [Self-Consistency Improves Chain of Thought Reasoning](https://arxiv.org/abs/2203.07870) (Wang et al., 2022) | • Multiple independent reasoning paths<br/>• Majority voting aggregation<br/>• Concurrent execution<br/>• Validation mode | • Mathematical problem solving<br/>• High-accuracy requirements<br/>• Decision making scenarios<br/>• Answer validation | `SelfConsistencyAgent` | [Guide](/agents/self-consistency-agent) |
| **Reasoning Duo** | Collaborative | Novel dual-agent architecture | • Separate reasoning and execution agents<br/>• Collaborative problem solving<br/>• Task decomposition<br/>• Cross-validation | • Complex analysis tasks<br/>• Multi-step problem solving<br/>• Tasks requiring verification<br/>• Research and planning | `ReasoningDuo` | [Guide](/agents/reasoning-duo) |
| **IRE Agent** | Iterative | Iterative Reflective Expansion framework | • Hypothesis generation<br/>• Path simulation<br/>• Error reflection<br/>• Dynamic revision | • Complex reasoning tasks<br/>• Research problems<br/>• Learning scenarios<br/>• Strategy development | `IterativeReflectiveExpansion` | [Guide](/agents/iterative-agent) |
| **Reflexion Agent** | Self-reflective | [Reflexion: Language Agents with Verbal Reinforcement Learning](https://arxiv.org/abs/2303.11366) (Shinn et al., 2023) | • Self-evaluation<br/>• Experience memory<br/>• Adaptive improvement<br/>• Learning from failures | • Continuous improvement tasks<br/>• Long-term projects<br/>• Learning scenarios<br/>• Quality refinement | `ReflexionAgent` | [Guide](/agents/reflexion-agent) |
| **GKP Agent** | Knowledge-based | [Generated Knowledge Prompting](https://arxiv.org/abs/2110.08387) (Liu et al., 2022) | • Knowledge generation<br/>• Multi-perspective reasoning<br/>• Information synthesis<br/>• Fact integration | • Knowledge-intensive tasks<br/>• Research questions<br/>• Fact-based reasoning<br/>• Information synthesis | `GKPAgent` | [Guide](/agents/gkp-agent) |
...
**Documentation**: [Self-Consistency Agent Guide](/agents/self-consistency-agent)
...
**Documentation**: [Reasoning Duo Guide](/agents/reasoning-duo)
...
**Documentation**: [IRE Agent Guide](/agents/iterative-agent)
...
**Documentation**: [Reflexion Agent Guide](/agents/reflexion-agent)
...
**Documentation**: [GKP Agent Guide](/agents/gkp-agent)
...
**Documentation**: [Agent Judge Guide](/agents/agent-judge)
...
**Documentation**: [REACT Agent Guide](https://github.com/kyegomez/swarms/blob/master/docs/swarms/agents/react_agent.md)
...
- [Self-Consistency Agent](/agents/self-consistency-agent)

- [Reasoning Duo](/agents/reasoning-duo)

- [IRE Agent](/agents/iterative-agent)

- [Reflexion Agent](/agents/reflexion-agent)

- [GKP Agent](/agents/gkp-agent)

- [Agent Judge](/agents/agent-judge)

- [Reasoning Agent Router](/agents/reasoning-agent-router)
