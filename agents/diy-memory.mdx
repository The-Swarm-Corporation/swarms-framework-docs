---
title: "Integrating RAG (DIY Memory)"
description: "Integrate database-backed memory systems like Pinecone, ChromaDB, and Faiss into the Agent class for long-term knowledge retention."
icon: "database"
---
