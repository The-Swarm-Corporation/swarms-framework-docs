---
title: "External Party Agents"
description: "Integrate external agents from frameworks like Langchain, Griptape, and more into Swarms by subclassing the Agent class."
icon: "puzzle-piece"
---
