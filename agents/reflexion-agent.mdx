...
description: Advanced AI agent that implements the Reflexion framework to improve through self-reflection by acting, evaluating, reflecting, and refining responses
icon: "rotate"
---
