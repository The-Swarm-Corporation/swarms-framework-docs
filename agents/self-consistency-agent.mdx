...
description: A specialized agent that generates multiple independent responses concurrently and aggregates them via majority voting for reliable answers
icon: "check-double"
---
