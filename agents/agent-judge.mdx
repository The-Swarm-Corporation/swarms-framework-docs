---
title: Agent Judge
description: Specialized agent that evaluates and judges outputs from other AI agents or systems, providing objective quality assessments and structured feedback
icon: "gavel"
---
