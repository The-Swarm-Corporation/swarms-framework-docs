...
description: "Build high-quality custom agents by extending the Agent class with type annotations, documentation, and modular design"
icon: "hammer"
---
...
class MyNewAgent(Agent):
    ...
    def __init__(self, name: str, system_prompt: str, description: str, model_name: str = None, llm: Callable = None):
        """
...
class GriptapeSwarmsAgent(SwarmsAgent):
    def __init__(self, name: str, system_prompt: str, *args, **kwargs):
