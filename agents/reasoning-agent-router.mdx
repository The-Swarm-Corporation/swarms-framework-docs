...
description: "Sophisticated routing system that dynamically selects and executes different reasoning strategies based on task requirements."
icon: "route"
---
...
<Tabs>
  ...
  <Tab title="Self-Consistency Examples">
    ```python
  ...
  <Tab title="ReasoningDuo Examples">
    ```python
    # Basic ReasoningDuo
    router = ReasoningAgentRouter(
