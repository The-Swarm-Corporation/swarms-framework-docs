...
- **Tasks**:
  ...
  - Improve or expand the content in the [swarms-framework-docs](https://github.com/The-Swarm-Corporation/swarms-framework-docs) repository
...
- **Current Architectures**:
  - [SequentialWorkflow](/architectures/sequential-workflow)
  - [AgentRearrange](/architectures/agent-rearrange)
  - [MixtureOfAgents](/architectures/mixture-of-agents)
  - [SpreadSheetSwarm](/api/spreadsheet-swarm)
  - [ForestSwarm](/api/forest-swarm)
  - [GraphWorkflow](/architectures/graph-workflow)
  - [GroupChat](/architectures/group-chat)
  - [SwarmRouter](/architectures/swarm-router)
...
- **Linting Tools**: The CI lint gate runs `black --check` and `ruff check .` — run `black .` and `ruff check .` locally before submitting
...
- **Agent Architecture**: [Agent Internal Mechanisms](/concepts/agents)
