...
<AccordionGroup>
  ...
  <Accordion title="What API keys do I need?">
    ...
    **Optional providers:**
    ...
    Learn more in the [Environment Configuration Guide](/environment-setup).
  </Accordion>
  ...
  <Accordion title="How do I configure environment variables?">
    ...
    See the [Environment Configuration Guide](/environment-setup).
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="How do I create my first agent?">
    ...
    Check out the [Agent documentation](/api/agent) for more details.
  </Accordion>
  ...
  <Accordion title="What swarm architectures are available?">
    ...
    See the [Multi-Agent Architectures guide](/concepts/swarms) for examples.
  </Accordion>
  ...
  <Accordion title="Can I use local models instead of API-based ones?">
    ...
    See the [Ollama examples](/integrations/model-providers).
  </Accordion>
  ...
  <Accordion title="How do I add tools to my agents?">
    ...
    See [Agent with Tools examples](/examples/agent-with-tools).
  </Accordion>
</AccordionGroup>
  ...
  <Accordion title="My agent isn't producing good results. What can I do?">
    ...
    5. **Use structured outputs:**
       ...
       agent = Agent(
           ...
           list_base_models=[Response],  # Adds the schema to the agent's memory as guidance
...
<AccordionGroup>
  <Accordion title="Where can I get help?">
    ...
    3. **Documentation**:
       ...
       - [Examples](/examples/overviews/examples-index)
