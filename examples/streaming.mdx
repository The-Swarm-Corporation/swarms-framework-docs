...
- [Multi-Agent Workflows](/architectures/concurrent-workflow) - Stream from multiple agents
- [Agent Output Types](/agents/structured-outputs) - Structure streaming outputs
- [Interactive GroupChat](/examples/group-chat-example) - Real-time agent interactions

## Learn More

- [Agent API Reference](/api/agent)
- [ConcurrentWorkflow Documentation](/architectures/concurrent-workflow)
- [Streaming Best Practices](/examples/agents/agent-streaming)
- [Dashboard Integration](/api/utils)