...
description: 'Integrate x402 native payments so agents can transact for paid services.'
icon: 'credit-card'
---
...
4. Deploy to production (see [Deployment Solutions](/deployment/agent-orchestration-protocol))
