...
description: 'Build an MCP server that exposes a Swarms agent as a tool, then call it from an MCP client over streamable HTTP.'
icon: 'plug'
---
...
| Step | Description |
|------|-------------|
| 1. Package Installation | Install MCP SDK, Swarms, and dependencies |
