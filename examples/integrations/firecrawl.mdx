...
<Note>
  Source: [examples/tools/firecrawl/firecrawl_agents_example.py](https://github.com/kyegomez/swarms/blob/master/examples/tools/firecrawl/firecrawl_agents_example.py)
</Note>
