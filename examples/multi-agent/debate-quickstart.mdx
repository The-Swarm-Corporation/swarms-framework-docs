---
title: 'Debate Swarm Quickstart'
description: 'Spin up a multi-agent debate where specialized agents argue and converge on conclusions.'
icon: 'comments'
---
...
- Explore [DebateWithJudge Reference](/api/debate-with-judge) for complete API details
