---
title: 'AOP Medical Swarm'
description: 'Run a medical-grade multi-agent system using the Agent Orchestration Protocol (AOP).'
icon: 'stethoscope'
---
...
- [AOP Reference](/api/aop)
- [MCP Integration](https://docs.swarms.ai/examples/mcp-integration)
- [Protocol Overview](/community/protocol-overview)
