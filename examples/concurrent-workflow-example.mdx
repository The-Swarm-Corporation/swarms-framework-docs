...
3. **Result Collection**: All three analyses are collected and returned as a list of role/content message dicts
...
- **[SwarmRouter](/examples/swarm-router-example)**: Switch between concurrent and other patterns dynamically

## Learn More

- [ConcurrentWorkflow API Reference](/api/concurrent-workflow)
- [Performance Optimization Guide](/deployment/scaling)
