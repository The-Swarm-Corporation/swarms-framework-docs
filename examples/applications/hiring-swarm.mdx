---
title: 'Hiring Swarm'
description: 'End-to-end hiring pipeline: source candidates, screen resumes, and run technical evaluations with agents.'
icon: 'user-tie'
---
...
class HiringSwarm:
    ...
    def initial_talent_acquisition(self):
        elena_agent = self.find_agent_by_name("Elena-Talent-Acquisition")
    ...
    def candidate_screening(self):
        marcus_agent = self.find_agent_by_name("Marcus-Candidate-Screening")
    ...
    def interview_coordination(self):
        olivia_agent = self.find_agent_by_name("Olivia-Interview-Coordinator")
    ...
    def onboarding_preparation(self):
        nathan_agent = self.find_agent_by_name("Nathan-Onboarding-Specialist")
    ...
    def employee_engagement_strategy(self):
        sophia_agent = self.find_agent_by_name("Sophia-Employee-Engagement")
