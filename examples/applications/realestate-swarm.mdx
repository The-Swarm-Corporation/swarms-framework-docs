---
title: 'Real Estate Swarm'
description: 'Real estate research, valuation, and deal-analysis swarm for residential and commercial properties.'
icon: 'house'
---
...
1.  **Install dependencies:**
    ...
    ```
2.  **Set up API Keys:**
    The `get_properties` tool below calls the Realty-in-US API on RapidAPI, which requires a `RAPIDAPI_KEY`.
