---
title: 'Smart Database Swarm'
description: 'An agent-powered intelligent database that queries, analyzes, and reasons over structured data.'
icon: 'database'
---
...
# =============================================================================
# DATABASE DIRECTOR SETTINGS
# =============================================================================
# HierarchicalSwarm builds its own director internally (with the structured
# OrderBatch output wiring it needs to delegate to workers), so a custom
# director's config is supplied via `director_settings=` rather than as a
# standalone Agent passed in `agents=`.
database_director_settings = {
...
smart_database_swarm = HierarchicalSwarm(
    ...
    director_settings=database_director_settings,
