...
- **[AgentRearrange](/architectures/agent-rearrange)**: Define complex agent relationships

## Learn More

- [SequentialWorkflow API Reference](/api/sequential-workflow)
- [Agent Configuration Guide](/agents/agent-configuration)
