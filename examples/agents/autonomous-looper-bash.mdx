---
title: 'Autonomous Looper with Bash'
description: 'Run an autonomous agent loop that can execute bash commands to complete long-horizon tasks.'
icon: 'terminal'
---
...
```
examples/single_agent/capabilities/autonomy/autonomous_agents/example_autonomous_looper_run_bash.py
```

## See also

- [Autonomous Looper Tools](/examples/agents/autonomous-looper-tools) – Configuring `selected_tools`
- [Agent Reference](/api/agent) – `selected_tools` and autonomous loop
