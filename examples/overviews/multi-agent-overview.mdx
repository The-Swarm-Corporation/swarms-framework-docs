...
| **Auto Agent Builder Quickstart** | Turns a plain-English task into a working roster of agents | [View Example](/examples/auto-agent-builder/quickstart) |
| **Dynamic Support Triage** | Builds a fresh team of specialists for every incoming ticket | [View Example](/examples/auto-agent-builder/triage) |
| **Reproducible Rosters** | Design a team once, then version, edit, and rerun it identically | [View Example](/examples/auto-agent-builder/reproducible) |
...
- [Custom Swarm Development](/concepts/custom-architectures)
