...
market_monitor = Agent(
    ...
    """,
    max_loops="auto",
    stopping_condition=lambda response: "market_close" in response.lower(),
)
```
...
- Explore [MixtureOfAgents](/concepts/swarms#mixture-of-agents-moa) for architecture details
