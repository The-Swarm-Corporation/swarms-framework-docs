...
Connect agents to the outside world — browsers, search, MCP servers, and payments.
...
| **MCP tool integrations** | Connect agents to real MCP servers: DeepWiki, Exa, Firecrawl, Hugging Face, Semgrep | [View Examples](/examples/mcp/overview) |
