...
# Use SwarmRouter for MoA — SwarmRouter always uses the LAST agent in the
# `agents` list as the aggregator, so it must be listed last here.
moa_router = SwarmRouter(
    swarm_type="MixtureOfAgents",
    agents=[writer, editor, reviewer, aggregator],
)
...
- **[SwarmRouter](/examples/swarm-router-example)**: Switch between MoA and other patterns

## Learn More

- [MixtureOfAgents API Reference](/api/mixture-of-agents)
