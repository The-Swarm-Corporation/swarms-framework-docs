...
chat = GroupChat(
    ...
    max_loops=4,  # Maximum number of messages posted
)
...
router = SwarmRouter(
    swarm_type="SequentialWorkflow",  # or "ConcurrentWorkflow", "MixtureOfAgents", etc.
...
<CardGroup cols={2}>
  ...
  <Card title="Examples" icon="code" href="/examples/overviews/examples-index">
    Explore real-world swarm implementations
  </Card>
  <Card title="Architecture Guide" icon="sitemap" href="/architectures/overview">
