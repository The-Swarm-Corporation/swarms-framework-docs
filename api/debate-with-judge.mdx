...
description: "A sophisticated debate architecture with self-refinement through a judge agent that evaluates Pro and Con arguments and synthesizes refined answers"
icon: "gavel"
---
