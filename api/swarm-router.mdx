---
title: SwarmRouter
description: A flexible routing system that manages different types of swarms for task execution through a unified interface
---
...
See [MultiAgentRouter Minimal Example](https://github.com/kyegomez/swarms/blob/master/docs/examples/multi_agent_router_minimal.md) for a lightweight demonstration.
