...
```csv
agent_name,description,system_prompt,task,model_name,max_loops
Research-Agent,Research specialist,You are a research agent,Research quantum computing,openai/gpt-5.4,1
Analysis-Agent,Data analyst,You are an analysis agent,Analyze the research findings,openai/gpt-5.4,1
```
