...
description: "A concurrent processing system that manages multiple agents to execute tasks simultaneously with CSV-based agent loading and automatic metadata tracking"
icon: "table"
---
...
| `model_name` | No | Model to use for the agent | `"anthropic/claude-sonnet-4-6"` |
