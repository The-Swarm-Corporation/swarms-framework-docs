...
description: "A comprehensive guide to building custom swarm systems that integrate multiple agents into a cohesive system capable of solving tasks collaboratively"
...
The swarm uses the Swarms framework's [Conversation structure](/api/conversation) for comprehensive message storage and management. This provides:
...
For complete documentation on conversation management, see the [Conversation Structure Documentation](/api/conversation).
...
For more advanced patterns and examples, explore the [Swarms Examples](https://github.com/kyegomez/swarms/blob/master/docs/examples/) and consider contributing your custom swarms back to the community by submitting a pull request to the [Swarms repository](https://github.com/kyegomez/swarms).

## Additional Resources

- [Conversation Structure Documentation](/api/conversation) - Complete guide to conversation management

- [Agent Documentation](/agents/creating-agents) - Learn about creating and configuring agents

- [Multi-Agent Architectures](/api/structs-overview) - Explore other swarm patterns and architectures

- [Examples Repository](https://github.com/kyegomez/swarms/blob/master/docs/examples/) - Real-world swarm implementations
