...
description: "A multi-loop consensus building system where multiple agents iteratively refine responses across loops, with each loop building on the previous consensus"
icon: "check-double"
---
