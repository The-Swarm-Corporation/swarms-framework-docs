...
<ParamField path="name" type="str" default="PlannerGeneratorEvaluator">
  Human-readable name for this harness.
</ParamField>

<ParamField path="description" type="str" default="Three-agent Planner-Generator-Evaluator harness with iterative feedback loop">
...
<ParamField path="planner_system_prompt" type="str" default="PLANNER_SYSTEM_PROMPT">
  System prompt for the Planner agent. Defaults to the built-in planner prompt.
</ParamField>

<ParamField path="generator_system_prompt" type="str" default="GENERATOR_SYSTEM_PROMPT">
  System prompt for the Generator agent. Defaults to the built-in generator prompt.
</ParamField>

<ParamField path="evaluator_system_prompt" type="str" default="EVALUATOR_SYSTEM_PROMPT">
