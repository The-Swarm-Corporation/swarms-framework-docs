---
title: "LLMCouncil"
description: "Orchestrates multiple specialized LLM agents to collaboratively answer queries through a structured peer review and synthesis process."
icon: "users"
---
...
For comprehensive examples demonstrating various use cases, see the [LLM Council Examples](https://github.com/kyegomez/swarms/tree/master/examples/multi_agent/llm_council_examples) directory:
...
- [Multi-Agent Architectures Overview](/api/structs-overview)
- [Council of Judges](/api/council-as-judge) - Similar peer review pattern
- [Agent Class Reference](/api/agent) - Understanding individual agents
- [Conversation Class Reference](/api/conversation) - Understanding conversation tracking and management
- [Multi-Agent Execution Utilities](/api/multi-agent-execution-utilities) - Underlying execution methods
- [History Output Formatter](https://github.com/kyegomez/swarms/blob/master/swarms/utils/history_output_formatter.py) - Output formatting utilities
