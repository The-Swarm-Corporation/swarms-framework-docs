...
description: A multi-agent orchestration system implementing a hierarchical workflow with a director coordinating specialized worker agents
---
...
│ └─ 🤖 Strategy-Consultant [claude-sonnet-4-6]│
└─────────────────────────────────────────┘
```
...
| **Model Selection** | A smaller model for the director/judge (e.g. `claude-sonnet-4-6`) reduces cost without sacrificing coordination quality |
