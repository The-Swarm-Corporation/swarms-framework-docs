...
description: Automatically builds and manages swarms of AI agents using a sophisticated boss agent system to delegate work and create specialized agents
---
...
| `model_name`         | str     | AI model name for processing tasks (e.g., 'claude-sonnet-4-6', 'claude-sonnet-4-6', 'openai/o3-mini')      |
...
| `model_name`    | str     | LLM model to use for the agent (e.g., 'claude-sonnet-4-6')                                         |
