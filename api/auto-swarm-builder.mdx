...
<ParamField path="swarm_type" type="str" default="return-agents">
...
<ParamField path="auto_execute" type="bool" default="False">
...
<ParamField path="execute" type="Optional[bool]" default="None">
