...
<ParamField path="id" type="Optional[str]" default="auto-generated">
...
<ParamField path="checkpoint_dir" type="Optional[str]" default="None">
  Directory for writing workflow checkpoints. When set, execution state can be persisted and resumed.
</ParamField>

<ParamField path="on_node_complete" type="Optional[Callable[[str, Any], None]]" default="None">
  Callback fired after each node finishes, receiving `(node_id, result)`. Can also be passed per-call to `run()`.
</ParamField>

<ParamField path="max_parallel_nodes" type="Optional[int]" default="None">
...
<ParamField path="streaming_callback" type="Optional[Callable[[str, str], None]]" default="None">
...
<ParamField path="raise_on_error" type="bool" default="False">
...
<ParamField path="spec" type="Dict[str, Any]" required>
  A topology spec as returned by `to_spec()` or loaded from a file written by `save_spec()`
</ParamField>

<ParamField path="agent_registry" type="Dict[str, Agent]" required>
