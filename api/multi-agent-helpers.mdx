---
title: "Multi-Agent Helpers"
description: "Built-in Agent class methods for facilitating communication and collaboration between multiple agents in complex workflows"
icon: "people-arrows"
---
