---
title: "ModelRouter"
description: "Intelligent routing system that automatically selects and executes AI models based on task requirements"
icon: "route"
---
...
<ParamField path="system_prompt" type="str" default="model_router_system_prompt">
...
<ParamField path="max_workers" type="int | str" default="10">
